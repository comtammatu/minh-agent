...
export function selectBudgetMetrics(result: BenchmarkResultLike, mode: PipelineBenchmarkMetricMode): MetricPair {
...
function evaluateSide(baselineMs: number, currentMs: number, maxRegressionPct: number): RegressionSide {
