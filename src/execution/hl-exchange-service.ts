 ...
 *
 * Renamed from ExchangeService → HLExchangeService (S8: multi-exchange refactor).
 * Callers should import via IExchangeService interface from exchange-service.ts.
 *
 * Responsibilities:
