  ...
  it("computes all fields correctly", () => {
    ...
    const allTrades: ClosedTradeRow[] = [
      ...
      makeTrade({
        coin: "BTC",
        realizedPnl: 500,
        closedAt: new Date("2026-02-15T10:00:00Z"),
      }),
      // Within 30 days
      makeTrade({
        coin: "ETH",
      ...
      makeTrade({
        coin: "BTC",
        realizedPnl: 300,
        closedAt: new Date("2026-03-28T10:00:00Z"),
      }),
      // Within 1 day
      makeTrade({
        coin: "SOL",
        realizedPnl: -100,
        closedAt: new Date("2026-03-31T06:00:00Z"),
      }),
      makeTrade({
        coin: "BTC",
        realizedPnl: 150,
        closedAt: new Date("2026-03-31T10:00:00Z"),
      }),
    ];
