...
import { MinhStrategy } from "./index.js";
...
describe("MinhStrategy — MINH_1H_CONFIDENCE_BASE", () => {
  const strategy = new MinhStrategy();

  it("StrategyParams accepts MINH_1H_CONFIDENCE_BASE (compile-time + runtime)", () => {
    const params: StrategyParams = { MINH_1H_CONFIDENCE_BASE: 0.65 };
    expect(params.MINH_1H_CONFIDENCE_BASE).toBe(0.65);
  });
