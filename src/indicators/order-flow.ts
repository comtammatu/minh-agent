...
import type { Candle, KeyZone, DeltaState, SignalSide, VolumeProfile } from '../types.js'
import {
...
function vpValueArea(bins: VPBin[], poc: number, pct: number): { vahIdx: number; valIdx: number } {
