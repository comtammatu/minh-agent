...
- Task Contract REQUIRED for 3+ step tasks (see `.Codex/rules/session-protocol.md`)
...
- Session protocol + task contract: `.Codex/rules/session-protocol.md`
- Quality gates: `.Codex/rules/quality-gates.md`
- Pattern invalidation rules: `.Codex/rules/invalidation-table.md`
