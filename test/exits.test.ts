...
describe('computeTrailingStop', () => {
  ...
  it('long: trail follows higher prices', () => {
    const prev: TrailingStopState = { active: true, highestPrice: 102, currentStopPrice: 101.49 }
    // Price moves to 104
  ...
  it('long: trail does not move down on pullback', () => {
    const prev: TrailingStopState = { active: true, highestPrice: 105, currentStopPrice: 104.475 }
...
describe('isTrailingStopHit', () => {
  it('long: hit when price <= stop', () => {
    const state: TrailingStopState = { active: true, highestPrice: 105, currentStopPrice: 104.475 }
  ...
  it('short: hit when price >= stop', () => {
    const state: TrailingStopState = { active: true, highestPrice: 95, currentStopPrice: 95.475 }
  ...
  it('not hit when inactive', () => {
    const state: TrailingStopState = { active: false, highestPrice: 100, currentStopPrice: 0 }
...
describe('computePartialCloseLevels', () => {
  ...
  it('custom config', () => {
    const config = { firstTpRatio: 1.5, firstClosePct: 0.33, moveSlToBreakeven: false, secondTpRatio: 3.0 }
