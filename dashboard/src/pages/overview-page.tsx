    ...
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Account snapshot, live exposure, runtime health, watchlist context,
          and recent journal activity.
        </p>
      </div>
      ...
      {data.bootstrap.phase !== "ready" ? (
        <Alert>
          ...
          <AlertDescription>
            The dashboard is live, but backfill has not finished yet. Watchlist
            and setups will stabilize once bootstrap completes.
          </AlertDescription>
        </Alert>
      ) : null}
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Errors {component.consecutiveErrors}
                  </p>
                </div>
                <Badge
                  variant={component.status === "ok" ? "default" : "secondary"}
                >
                  {component.status}
                </Badge>
              </div>
