...
export function JournalPage() {
  ...
  const eventType = EVENT_OPTIONS.includes(
  ...
  }, [coin, eventType, searchParams, setSearchParams, snapshot.data]);
    ...
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Filter the live event ledger and inspect full event details without
        ...
        <CardContent className="grid gap-3 md:grid-cols-2 xl:max-w-xl">
          <div className="grid gap-2">
            ...
            >
              <SelectTrigger
                className="min-w-44"
                aria-label="Filter journal by coin"
              >
          ...
          <div className="grid gap-2">
            ...
            >
              <SelectTrigger
                className="min-w-44"
                aria-label="Filter journal by event type"
              >
      ...
      >
        <SheetContent side="right" className="w-full sm:max-w-xl">
          <SheetHeader>
            ...
            <SheetDescription>
              {selected ? formatTimestamp(selected.ts) : "—"}
            </SheetDescription>
          </SheetHeader>
